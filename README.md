...
Read books everyday, constantly. Inbetween physical activities, or whenever there's down time. If you've read a particular book to them a couple times already, start redacting nouns/proper nouns when reading it again–and let them guess what the word is (reinforces critical thinking and word memory).
...
* Introduction to gravity, force, mass, and inertia:
  ...
  * 'Soccer Ball Physics': When kicking a soccer ball together, talk about how everthing has mass. And how force affects things with mass like the soccer ball (the force from our legs kicking it). 
